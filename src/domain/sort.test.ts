...
describe('compareProjects / compareGoals', () => {
  it('projects: bumpCount DESC then name ASC', () => {
    const a = createProject({ writerId: D, name: 'Banana', bumpCount: 2 })
    const b = createProject({ writerId: D, name: 'Apple', bumpCount: 2 })
    const c = createProject({ writerId: D, name: 'Cherry', bumpCount: 9 })
  ...
  it('goals: bumpCount DESC then name ASC', () => {
    const a = createGoal({ writerId: D, name: 'Zeta', bumpCount: 0 })
    const b = createGoal({ writerId: D, name: 'Alpha', bumpCount: 0 })
